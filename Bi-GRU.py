...
if __name__ == '__main__':
    ...
    fc1_in = tf.reshape(fc1_in, [-1, n_fc1_cells])
    fc1_out = tf.nn.relu(tf.matmul(x_in, fc1_Weights) + fc1_Biases)
    # Bi-GRU layer
    ...
    #(soft-max)
    softmax_Weights = tf.Variable(tf.random_normal([n_gru_cells, n_classes]), name='fc2_W')
